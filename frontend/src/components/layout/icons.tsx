...
export function FacebookIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden="true">
      ...
      <path
        d="M14.5 8.5h-1.4c-.3 0-.6.3-.6.7v1.4h2l-.3 2.1h-1.7V19h-2.2v-6.3H8.6v-2.1h1.7V9c0-1.6 1-2.7 2.5-2.7h1.7v2.2z"
        fill="#fff"
      />
    </svg>
  );
...
export function WhatsAppIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden="true">
      <path d="M12.001 2c-5.524 0-10 4.476-10 10 0 1.764.46 3.487 1.334 5.006L2 22l5.132-1.312A9.936 9.936 0 0 0 12 22c5.523 0 10-4.477 10-10S17.524 2 12.001 2zm0 18.031a8.001 8.001 0 0 1-4.09-1.124l-.293-.174-3.048.78.813-2.973-.191-.305A7.983 7.983 0 0 1 4 12c0-4.411 3.589-8 8.001-8 4.411 0 7.999 3.589 7.999 8 0 4.412-3.588 8.031-7.999 8.031z" />
